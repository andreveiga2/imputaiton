...
def create_dummy_set(training_variables_type = 3, plot_type = 2):
    ...
    if plot_type == 2:
        ...
        dummy_set['sqrt_prod_decision_phi_0'] = (np.multiply((dummy_set['decision_gar_0']+1),dummy_set['phi']))**0.3
        dummy_set['sqrt_prod_decision_phi_5'] = (np.multiply((dummy_set['decision_gar_5']+1),dummy_set['phi']))**0.3
        dummy_set['sqrt_prod_decision_phi_10'] = (np.multiply((dummy_set['decision_gar_10']+1),dummy_set['phi']))**0.3
        ...
        dummy_set['dd_freq_m'] = np.array([0]*38230)
        dummy_set['dd_freq_q'] = np.array([0]*38230)
        dummy_set['dd_freq_h'] = np.array([0]*38230)
        dummy_set['dd_pcode_H'] = np.array([0]*38230)
        dummy_set['dd_pcode_M'] = np.array([1]*38230)
        dummy_set['dd_pcode_L'] = np.array([0]*38230)
        dummy_set['fa'] = np.array([0]*38230)
        dummy_set['dd_sales_D'] = np.array([0]*38230)
        dummy_set['dd_scheme_no'] = np.array([1]*38230)
        ...
        try:
            if training_variables_type == 1:
                ...
                if training_variables_type == 2:
                    ...
                    plot_variables_0 = [dummy_set['decision_gar_0'], dummy_set['buy_age'], dummy_set['YM'], dummy_set['male'], dummy_set['sqrt_decision_gar_0'], dummy_set['sqrt_phi'], dummy_set['sqrt_prod_decision_phi_0'], dummy_set['sqrt_sum_decision_phi_0']]
                    plot_variables_5 = [dummy_set['decision_gar_5'], dummy_set['buy_age'], dummy_set['YM'], dummy_set['male'], dummy_set['sqrt_decision_gar_5'], dummy_set['sqrt_phi'], dummy_set['sqrt_prod_decision_phi_5'], dummy_set['sqrt_sum_decision_phi_5']]
                    plot_variables_10 = [dummy_set['decision_gar_10'], dummy_set['buy_age'], dummy_set['YM'], dummy_set['male'], dummy_set['sqrt_decision_gar_10'], dummy_set['sqrt_phi'], dummy_set['sqrt_prod_decision_phi_10'], dummy_set['sqrt_sum_decision_phi_10']]
