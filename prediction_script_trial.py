...
def create_dummy_set(training_variables_type = 4, plot_type = 2):
    """
    ...
    if plot_type == 2:
        ...
        # In this case shape of phi is 9999 X 1
        dummy_set['phi'] = np.arange(100,1000000, 100)
        #print phi.shape

        # will need to set initializations based on plot_type
        dummy_set['external'] = np.array([0]*9999)
        dummy_set['buy_age'] = np.array([60]*9999)
        dummy_set['YM'] = np.array([2006.583]*9999)
        dummy_set['male'] = np.array([1]*9999)

        dummy_set['decision_gar_0'] = np.array([0]*9999)
        dummy_set['decision_gar_5'] = np.array([5]*9999)
        dummy_set['decision_gar_10'] = np.array([10]*9999)


        dummy_set['dd_freq_m'] = np.array([0]*9999)
        dummy_set['dd_freq_q'] = np.array([0]*9999)
        dummy_set['dd_freq_h'] = np.array([0]*9999)
        dummy_set['dd_pcode_H'] = np.array([0]*9999)
        dummy_set['dd_pcode_M'] = np.array([1]*9999)
        dummy_set['dd_pcode_L'] = np.array([0]*9999)
        dummy_set['fa'] = np.array([0]*9999)
        dummy_set['dd_sales_D'] = np.array([0]*9999)
        dummy_set['dd_scheme_no'] = np.array([1]*9999)

        dummy_set['yield6'] = np.array([4.66]*9999)
        dummy_set['yield12'] = np.array([4.71]*9999)
        dummy_set['yield18'] = np.array([4.71]*9999)
        dummy_set['yield24'] = np.array([4.71]*9999)
        dummy_set['yield30'] = np.array([4.71]*9999)
        dummy_set['yield36'] = np.array([4.7]*9999)
        dummy_set['yield42'] = np.array([4.69]*9999)
        dummy_set['yield48'] = np.array([4.69]*9999)
        dummy_set['yield54'] = np.array([4.68]*9999)
        dummy_set['yield60'] = np.array([4.67]*9999)
        dummy_set['yield66'] = np.array([4.66]*9999)
        dummy_set['yield72'] = np.array([4.64]*9999)
        dummy_set['yield78'] = np.array([4.63]*9999)
        dummy_set['yield84'] = np.array([4.62]*9999)
        dummy_set['yield90'] = np.array([4.61]*9999)
        dummy_set['yield96'] = np.array([4.6]*9999)
        dummy_set['yield102'] = np.array([4.58]*9999)
        dummy_set['yield108'] = np.array([4.57]*9999)
        dummy_set['yield114'] = np.array([4.56]*9999)
        dummy_set['yield120'] = np.array([4.55]*9999)
        dummy_set['yield126'] = np.array([4.54]*9999)
        dummy_set['yield132'] = np.array([4.53]*9999)
        dummy_set['yield138'] = np.array([4.51]*9999)
        dummy_set['yield144'] = np.array([4.5]*9999)
        dummy_set['yield150'] = np.array([4.49]*9999)
        dummy_set['yield156'] = np.array([4.48]*9999)
        dummy_set['yield162'] = np.array([4.47]*9999)
        dummy_set['yield168'] = np.array([4.46]*9999)
        dummy_set['yield174'] = np.array([4.45]*9999)
        dummy_set['yield180'] = np.array([4.44]*9999)
        dummy_set['yield186'] = np.array([4.42]*9999)
        dummy_set['yield192'] = np.array([4.41]*9999)
        dummy_set['yield198'] = np.array([4.4]*9999)
        dummy_set['yield204'] = np.array([4.38]*9999)
        dummy_set['yield210'] = np.array([4.37]*9999)
        dummy_set['yield216'] = np.array([4.36]*9999)
        dummy_set['yield222'] = np.array([4.34]*9999)
        dummy_set['yield228'] = np.array([4.33]*9999)
        dummy_set['yield234'] = np.array([4.31]*9999)
        dummy_set['yield240'] = np.array([4.3]*9999)
        dummy_set['yield246'] = np.array([4.28]*9999)
        dummy_set['yield252'] = np.array([4.27]*9999)
        dummy_set['yield258'] = np.array([4.25]*9999)
        dummy_set['yield264'] = np.array([4.24]*9999)
        dummy_set['yield270'] = np.array([4.22]*9999)
        dummy_set['yield276'] = np.array([4.21]*9999)
        dummy_set['yield282'] = np.array([4.2]*9999)
        dummy_set['yield288'] = np.array([4.18]*9999)
        dummy_set['yield294'] = np.array([4.17]*9999)
        dummy_set['yield300'] = np.array([4.15]*9999)
        ...
        try:
            if training_variables_type == 1:
                ...
                plot_variables_0 = [dummy_set['decision_gar_0']]
                plot_variables_5 = [dummy_set['decision_gar_5']]
                plot_variables_10 = [dummy_set['decision_gar_10']]

            else:
                X_plot_0 = dummy_set['external']
                X_plot_5 = dummy_set['external']
                X_plot_10 = dummy_set['external']

                if training_variables_type == 2:
                    plot_variables_0 = [dummy_set['dd_freq_m'], dummy_set['dd_freq_q'], dummy_set['dd_freq_h'], dummy_set['phi'], dummy_set['decision_gar_0']]
                    plot_variables_5 = [dummy_set['dd_freq_m'], dummy_set['dd_freq_q'], dummy_set['dd_freq_h'], dummy_set['phi'], dummy_set['decision_gar_5']]
                    plot_variables_10 = [dummy_set['dd_freq_m'], dummy_set['dd_freq_q'], dummy_set['dd_freq_h'], dummy_set['phi'], dummy_set['decision_gar_10']]
                elif training_variables_type == 3:
                    X_plot_0 = dummy_set['phi']
                    X_plot_5 = dummy_set['phi']
                    X_plot_10 = dummy_set['phi']
                    plot_variables_0 = [dummy_set['decision_gar_0'], dummy_set['buy_age'], dummy_set['YM'], dummy_set['male']]
                    plot_variables_5 = [dummy_set['decision_gar_5'], dummy_set['buy_age'], dummy_set['YM'], dummy_set['male']]
                    plot_variables_10 = [dummy_set['decision_gar_10'], dummy_set['buy_age'], dummy_set['YM'], dummy_set['male']]
                elif training_variables_type == 4:

                    plot_variables_0 = [dummy_set['dd_freq_m'], dummy_set['dd_freq_q'], dummy_set['dd_freq_h'], dummy_set['phi'], dummy_set['decision_gar_0'],
                                        dummy_set['dd_pcode_H'], dummy_set['dd_pcode_M'], dummy_set['dd_pcode_L'], dummy_set['fa'], dummy_set['buy_age'], dummy_set['YM'], dummy_set['male'], dummy_set['dd_sales_D'],
                                        dummy_set['dd_scheme_no'], dummy_set['yield6'], dummy_set['yield12'], dummy_set['yield18'], dummy_set['yield24'], dummy_set['yield30'], dummy_set['yield36'], dummy_set['yield42'],
                                        ...
                                        dummy_set['yield288'], dummy_set['yield294'], dummy_set['yield300'] ]
...
def prediction(X_train, y_train, X_test, y_test, model_type = 'MLPRegressor'):
    """
    ...
    # ('Prediction Error', 4308, ' / ', 4560, ' (', 'relu', 'lbfgs', 120, 0.13, 0.0007000000000000001, 7.030883351813102)
    # ('Lowest Error: (', 'relu', 'adam', 120, 0.09, 0.00030000000000000003, 5.562046373270918)
    ...
    optimal_params['hidden_size'] = 120
    optimal_params['learning_rate'] = 0.09
    optimal_params['alpha'] = 0.0003
    ...
    (X_plot_0, X_plot_5, X_plot_10, dummy_set) = create_dummy_set(training_variables_type = 4, plot_type = 2)
    ...
    print(str(count)+" out of "+str(len(plot_prediction_0))+" predictions have r_0 < r_5 < r_10")
